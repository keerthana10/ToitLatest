...
public class PurchaseProductFilterSales extends javax.swing.JPanel implements EditorCreator {
    
    private SentenceList m_sentcat;
    private ComboBoxValModel m_CategoryModel;
    
    /** Creates new form ProductFilterSales */
    public PurchaseProductFilterSales(DataLogicSales dlSales, JEditorKeys jKeys) {
        initComponents();
