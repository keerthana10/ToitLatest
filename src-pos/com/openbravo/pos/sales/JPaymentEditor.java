...
public class JPaymentEditor extends JDialog {
   ...
   //     m_dPaid = cardValue;
    ...
    private void initComponents() {
        ...
        jPaymentPanel.add(jLabelMobile, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 150, 70, 40));
        ...
        jPaymentPanel.add(m_jMobile, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 160, 180, -1));
        ...
        jPaymentPanel.add(m_jTextMobileSplit, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 160, 170, 25));
        ...
        jViewPanelLayout.setHorizontalGroup(
            ...
            .add(jPaymentPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 314, Short.MAX_VALUE)
            .add(jViewPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                .add(jVoucherPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 318, Short.MAX_VALUE))
            .add(jViewPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                .add(jChequePanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 318, Short.MAX_VALUE))
            .add(jViewPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                .add(jStaffPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 318, Short.MAX_VALUE))
        );
        jViewPanelLayout.setVerticalGroup(
            jViewPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(jViewPanelLayout.createSequentialGroup()
                .add(jPaymentPanel, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 316, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .add(0, 2, Short.MAX_VALUE))
            .add(jViewPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                .add(jViewPanelLayout.createSequentialGroup()
                    .add(jVoucherPanel, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 318, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    .add(0, 0, Short.MAX_VALUE)))
            .add(jViewPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                .add(jViewPanelLayout.createSequentialGroup()
                    .add(jChequePanel, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 317, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    .add(0, 1, Short.MAX_VALUE)))
            .add(jViewPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                .add(jViewPanelLayout.createSequentialGroup()
                    .add(jStaffPanel, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 316, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    .add(0, 2, Short.MAX_VALUE)))
        );
    ...
    private void m_jPayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jPayActionPerformed
        ...
        double mobileAmount=0;
         ...
         if(m_jCash.getText().equals("") && m_jCard.getText().equals("") && m_jMobile.getText().equals("")&&  m_jVoucher.getText().equals("")){
            ...
            JRetailPanelTicket.settleBill(totalBillValue,cashAmount,cardAmount,mobileAmount,voucherAmount);   // TODO add your handling code here:
