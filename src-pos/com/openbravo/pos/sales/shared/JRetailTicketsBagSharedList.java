...
public class JRetailTicketsBagSharedList extends javax.swing.JDialog {
    ...
    private JRetailTicketsBagSharedList(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    }
    /** Creates new form JTicketsBagSharedList */
    private JRetailTicketsBagSharedList(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
    }  
    ...
    public static JRetailTicketsBagSharedList newJDialog(JRetailTicketsBagShared ticketsbagshared) {
        
        Window window = getWindow(ticketsbagshared);
        JRetailTicketsBagSharedList mydialog;
        if (window instanceof Frame) { 
            mydialog = new JRetailTicketsBagSharedList((Frame) window, true);
        } else {
            mydialog = new JRetailTicketsBagSharedList((Dialog) window, true);
        } 
            ...
            public void actionPerformed(ActionEvent e) {
                //do nothing
                   m_sDialogTicket = m_Ticket.getId();
                    ...
                    // y oculto la ventana
                    JRetailTicketsBagSharedList.this.setVisible(false);
            }
        };
            InputMap imap = getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW);

            imap.put(KeyStroke.getKeyStroke("ENTER"), "doNothing");
