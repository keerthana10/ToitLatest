...
public class JRetailTicketCatalogLines extends javax.swing.JPanel {
    
    private JRetailRefundLines m_reflines;
    private CatalogSelector m_catalog;
    
    /** Creates new form JRetailTicketCatalogLines */
    public JRetailTicketCatalogLines(AppView app, JRetailPanelTicketEdits jTicketEdit, boolean pricevisible, boolean taxesincluded, int width, int height) {
        ...
        m_reflines = new JRetailRefundLines(dlSystem, jTicketEdit);
